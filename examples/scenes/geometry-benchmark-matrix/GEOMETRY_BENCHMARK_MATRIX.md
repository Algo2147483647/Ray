...
Placeholder cells use clear-glass spheres with radius $R=0.16$. Cell r1-c1 is a grouped cell containing the original circle and the triangle moved from r2-c4.
...
r5-c4: Roman surface / upward-pointing screen orientation
...
r3-c5: Transparent placeholder sphere
...
r2-c4: Transparent placeholder sphere
r2-c5: Transparent placeholder sphere
r2-c6: Szilassi polyhedron
r2-c7: Hyperboloid quadric  

r1-c1: Grouped circle and triangle
r1-c2: Oblique cylinder
r1-c3: Transparent placeholder sphere
r1-c4: Transparent placeholder sphere
r1-c5: Transparent placeholder sphere
r1-c6: Transparent placeholder sphere
r1-c7: Transparent placeholder sphere

## Row 1

| Cell | Mathematical Geometry | Formula / Definition | Material |
| --- | --- | --- | --- |
| r1-c1 | Grouped finite disk and triangle | `shape: "group"` combines a scaled disk $D_R^2$, $R=0.22$ before group scale, with the filled triangle moved from r2-c4 into the same cell. | `emissive-cyan`: constant cyan emission, color `[0.5, 3.6, 4.8]`; `fabric-teal`: Lambertian teal fabric, albedo `[0.05, 0.42, 0.38]`. |
...
| r1-c3 | Transparent placeholder sphere | Clear-glass sphere $S_R^2$, $R=0.16$, used as a placeholder for this cell. | `clear-glass`: specular dielectric, transmittance `[1, 1, 1]`, eta `1.5`. |
| r1-c4 | Transparent placeholder sphere | Clear-glass sphere $S_R^2$, $R=0.16$, used as a placeholder for this cell. | `clear-glass`: specular dielectric, transmittance `[1, 1, 1]`, eta `1.5`. |
| r1-c5 | Transparent placeholder sphere | Clear-glass sphere $S_R^2$, $R=0.16$, used as a placeholder for this cell. | `clear-glass`: specular dielectric, transmittance `[1, 1, 1]`, eta `1.5`. |
| r1-c6 | Transparent placeholder sphere | Clear-glass sphere $S_R^2$, $R=0.16$, used as a placeholder for this cell. | `clear-glass`: specular dielectric, transmittance `[1, 1, 1]`, eta `1.5`. |
| r1-c7 | Transparent placeholder sphere | Clear-glass sphere $S_R^2$, $R=0.16$, used as a placeholder for this cell. | `clear-glass`: specular dielectric, transmittance `[1, 1, 1]`, eta `1.5`. |
...
| r2-c4 | Transparent placeholder sphere | Clear-glass sphere $S_R^2$, $R=0.16$, occupying the former triangle cell after the triangle was moved into r1-c1. | `clear-glass`: specular dielectric, transmittance `[1, 1, 1]`, eta `1.5`. |
| r2-c5 | Transparent placeholder sphere | Clear-glass sphere $S_R^2$, $R=0.16$, used as a placeholder for this cell. | `clear-glass`: specular dielectric, transmittance `[1, 1, 1]`, eta `1.5`. |
...
| r3-c5 | Transparent placeholder sphere | Clear-glass sphere $S_R^2$, $R=0.16$, used as a placeholder for this cell. | `clear-glass`: specular dielectric, transmittance `[1, 1, 1]`, eta `1.5`. |
...
| r5-c4 | Roman surface | Steiner Roman surface $x^2y^2+y^2z^2+z^2x^2-xyz=0$, rotated so its local $[1,1,1]$ threefold face axis points toward the camera, then rolled about the front-back world-$x$ axis so one triangular point faces upward; left unbounded, moved from r3-c4. | `pale-pink-sheen`: pale pink specular reflection, reflectance `[0.96, 0.68, 0.76]`. |
