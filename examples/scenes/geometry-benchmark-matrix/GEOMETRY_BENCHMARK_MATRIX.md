...
| r3-c4 | Roman surface | Steiner Roman surface $x^2y^2+y^2z^2+z^2x^2-xyz=0$, a self-intersecting quartic. | `pale-pink-sheen`: pale pink specular reflection, reflectance `[0.96, 0.68, 0.76]`. |
...
| r6-c5 | Chmutov surface / Banchoff form | Degree-$8$ Chmutov surface in Banchoff form $T_8(x)+T_8(y)+T_8(z)=0$, with $T_8(u)=128u^8-256u^6+160u^4-32u^2+1$. | `pale-blue-glass`: transparent pale-blue specular dielectric, transmittance `[0.82, 0.92, 1]`, eta `1.5`. |
